...
//  xFuel
//
//  Created by Julian Kleine on 14.07.13.
//  Copyright (c) 2013 Julian Kleine. All rights reserved.
//

#import <UIKit/UIKit.h>

typedef NS_ENUM(NSUInteger, JKPageControlAlignment) {
	JKPageControlAlignmentLeft = 1,
	JKPageControlAlignmentCenter,
	JKPageControlAlignmentRight
};

typedef NS_ENUM(NSUInteger, JKPageControlVerticalAlignment) {
	JKPageControlVerticalAlignmentTop = 1,
	JKPageControlVerticalAlignmentMiddle,
	JKPageControlVerticalAlignmentBottom
};
...
@property (nonatomic) JKPageControlAlignment alignment					UI_APPEARANCE_SELECTOR; // deafult is Center
@property (nonatomic) JKPageControlVerticalAlignment verticalAlignment	UI_APPEARANCE_SELECTOR;	// deafult is Middle
